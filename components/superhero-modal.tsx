...
import { LoadingSpinner, StatBar } from "@/components";
import { useGetSuperhero } from "@/hooks";
import { capitalizeEachCommaSeparatedPart } from "@/utils";
...
export const SuperheroModal = ({ superheroId, isOpen, onClose }: Props) => {
  const {
    data: superhero,
    loading,
    error,
    refetch,
  } = useGetSuperhero({ id: superheroId });
      ...
      <div className="bg-white dark:bg-gray-800 rounded-lg max-w-4xl w-full max-h-[90vh] overflow-y-auto animate-slide-up">
        <div className="sticky top-0 bg-white dark:bg-gray-800 border-b dark:border-gray-700 p-4 flex justify-between items-center">
          <h2 className="text-2xl font-bold text-gray-900 dark:text-white">
            {loading ? "Loading..." : superhero?.name || "Unknown"}
          </h2>

          <button
            title="Close"
            onClick={onClose}
            className="cursor-pointer p-2 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-full transition-colors"
          >
                ...
                <div className="space-y-4">
                  <div className="space-y-1">
                    ...
                    <p className="text-sm text-gray-600 dark:text-gray-300">
                      ...
                      {capitalizeEachCommaSeparatedPart(
